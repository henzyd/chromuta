...
export const NAMED_COLOR_LIST: readonly string[] = Object.freeze(Object.keys(NAMED_COLORS));

/**
 * Reverse lookup, hex -> name. Several colors have two spellings (gray/grey,
 * aqua/cyan); the first key wins so lookups are deterministic.
 */
...
export function isNamedColor(word: string): boolean {
  return Object.prototype.hasOwnProperty.call(NAMED_COLORS, word.toLowerCase());
}
