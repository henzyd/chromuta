...
export function xyzD65ToLinearRgb(xyz: Xyz): Rgb {
  return {
    ...
    g: -0.9692436362808798 * xyz.x + 1.8759675015077206 * xyz.y + 0.04155505740717561 * xyz.z,
    b: 0.05563007969699361 * xyz.x - 0.20397695888897652 * xyz.y + 1.0569715142428786 * xyz.z
  };
}
